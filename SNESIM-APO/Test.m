...
params.XML.parameters.Nb_Realizations.value=5;
nb_realz=params.XML.parameters.Nb_Realizations.value; %nb_realz: number of realizations
%% Parameters to OPtimize
params.XML.parameters.Nb_Multigrids_ADVANCED.value=3;%number of multiple grids=x(1)
params.XML.parameters.Cmin.value=2;%minimum replicates number=x(2)
params.XML.parameters.Max_Cond.value=30;%maximum number of conditional data=x(3)
