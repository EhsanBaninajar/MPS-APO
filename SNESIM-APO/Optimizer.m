...
Global_var
%% objective Function
nsim=10;    % Number of function evaluation
...
%% Loading Ti
%Training Image
[Ti,Xsize_Ti,Ysize_Ti,Zsize_Ti,nbvar_Ti,namevar_Ti]=LoadGrid('marblecatnew.sgems');
gapdatabase
%% SPSA
%parameter initialization
theta=[0.01; 0.01; 0.1];% Maximum number of conditioning data, minimum number of replicates, number of multiple grids
thetamin=[0.01; 0.01; 0.1];
thetamax=[1; 0.6; 1];
...
for k=0:NSPSA-1
    ...
    if counter==5 && stage==0
        ...
        hold on
        subplot(3,1,1)
        line([k,k],[0,thetamax(1)*100],'color','red')
        subplot(3,1,2)
        line([k,k],[0,thetamax(1)*100],'color','red')
        subplot(3,1,3)
